...
legend()
xlabel('Station');
ylabel('Fuel-Specific Flow Exergy (MJ/kg_{fuel}-K)');
hold off
...
ylabel('Exergy Loss (%)')
text(7,30,sprintf('LHV Efficiency: %.1f%%', Eff_gas_turbine*100))
text(7,25,sprintf('Exergy Efficiency: %.1f%%', Eff_exergy*100))
hold off
