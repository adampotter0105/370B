...
X_des_fuel_comp     = (FXf1 - FXf2 + W_fuel_comp/1e6);
X_des_air_comp      = (FXa1 - FXa2 + W_air_comp/1e6);
X_des_premixer      = (FXf2 + FXa2 - FXm3);
X_des_combustor     = (FXm3 - FXm4);
X_des_gas_turbine   = (FXm4 - FXm5 - W_gas_turb/1e6);
X_des_HRSG          = (FXm5 + FXw2 - FXm8 - FXw5);
X_des_feed_pump     = (FXw1 - FXw2 + W_feed_pump/1e6);
X_des_steam_turbine = (FXw5 - FXw6 - W_steam_turb/1e6);
X_des_condenser     = (FXw6 - FXw7);
X_des_condenser_pump = (FXw7 - FXw8 + W_cond_pump/1e6);
X_des_cold_storage  = (FXw8 - FXw1);
X_des_flue_gas      = (FXm8);
...
Eff_exergy          = W_gas_net/(FXf1 + FXa1);
