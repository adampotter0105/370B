...
hlist = [-9.3 -9.2 -9.1 -9.0 -8.9 -8.8]*1e6;
...
for i=1:1:length(hlist)
    text(senthline(i,1)/1000,Tenthline(i,1),num2str(hlist(i)/1e6),'Color','r')
end
legend('Isobar (bar)','Isochore (m^3/kg)','Isenthalp (MJ/kg)','Critical Point','Triple Line')
title('Carbon Dioxide')
scale = axis;
axis([scale(1) scale(2) 200 520])
plotfixer
